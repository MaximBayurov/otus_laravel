                    ...
                    <th scope="row">
                        <div class="dropdown-center">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{route('admin.constructions.edit', $construction->id)}}">Редактировать</a></li>
                                <li><a class="dropdown-item" href="{{route('admin.constructions.show', $construction->id)}}">Просмотр</a></li>
                                <li class="border-top my-3"></li>
                                <li>
                                    <form action="{{route('admin.constructions.destroy', ['construction' => $construction->id])}}" method="POST">
                                        @method('DELETE')
                                        @csrf
