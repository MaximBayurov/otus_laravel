@php use App\Enums\Permissions\Admin; @endphp
@extends('layouts.base')

@section('html-class', 'h-100')
@section('body-class', 'bg-white d-flex flex-column h-100')
@section('head-bottom')
    ...
    <header class="p-3 border-bottom bg-light">
        <div class="container">
            <div class="d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="dropdown text-end">
                        <a href="#" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                           data-bs-toggle="dropdown" aria-expanded="false">
                            @php
                                $userProfileImageUrl = Auth::user()->profile_image_url ?? fake()->imageUrl(gray: true);
                            @endphp
                            <img src="{{$userProfileImageUrl}}" alt="Фото профиля" width="32" height="32"
                                 class="rounded-circle">
                        </a>
                        <ul class="dropdown-menu text-small">
                            <li><a class="dropdown-item" href="{{route('profile')}}">Профиль</a></li>
                            @can('admin.home')
                                <li><a class="dropdown-item" href="{{route('admin.home')}}">Административный раздел</a></li>
                            @endcan
                            <li>
                ...
                @else
                    <div class="text-end">
                        <a href="{{route('login.form')}}" class="btn btn-outline-primary me-2">Вход</a>
